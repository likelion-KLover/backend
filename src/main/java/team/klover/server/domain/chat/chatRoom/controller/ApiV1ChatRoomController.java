...
public class ApiV1ChatRoomController {
    ...
    public ApiResponse<ChatRoomDto> addChatRoom(@RequestBody @Valid ChatRoomCreateForm chatRoomForm
                                           //ChatRoomForm chatRoomForm
    ) {
        Long currentMemberId = AuthUtil.getCurrentMemberId();
        ChatRoomDto dto = chatRoomService.addChatRoom(currentMemberId, chatRoomForm);
    ...
    public ApiResponse<String> updateChatRoomTitle(@PathVariable("chatRoomId") Long chatRoomId, @RequestBody @Valid ChatRoomTitleUpdateForm chatRoomForm
                                                   //ChatRoomForm chatRoomForm
    ) {
        Long currentMemberId = AuthUtil.getCurrentMemberId();
    ...
    public ApiResponse<String> inviteChatRoomMember(@PathVariable("chatRoomId") Long chatRoomId, @RequestBody @Valid ChatRoomBatchActionForm chatRoomForm
                                                    //ChatRoomForm chatRoomForm
    ) {
        Long currentMemberId = AuthUtil.getCurrentMemberId();
    ...
    public ApiResponse<String> kickOutChatRoomMember(@PathVariable("chatRoomId") Long chatRoomId, @RequestBody @Valid ChatRoomBatchActionForm chatRoomForm
    //ChatRoomForm chatRoomForm
    ) {
        Long currentMemberId = AuthUtil.getCurrentMemberId();
